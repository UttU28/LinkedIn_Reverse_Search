  ...
  const features = [
    {
      ...
      description: "Our sophisticated algorithms construct precise search queries using multiple data points to find the right LinkedIn profiles with high accuracy.",
    ...
    },
    {
      ...
      description: "Get LinkedIn profile links in seconds, not hours, significantly accelerating your workflow.",
      ...
      >
        ...
        >
          <div className="text-center mb-12">
            ...
            <p className="text-secondary-text max-w-2xl mx-auto">
              Our platform is designed to make LinkedIn profile discovery effortless and efficient, helping you find the right professionals quickly.
            </p>
          </div>
        ...
        >
          <div className="text-center mb-12">
            ...
            <p className="text-secondary-text max-w-2xl mx-auto">
              A simple three-step process to find the LinkedIn profiles you need.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              ...
              <div className="bg-primary text-white text-xl font-bold h-8 w-8 rounded-full flex items-center justify-center mx-auto -mt-12 mb-6">
                1
              </div>
              <h3 className="text-xl font-heading font-medium text-primary-text mb-3">
                Input Your Data
            ...
            >
              ...
              <p className="text-secondary-text">
                Review and export accurate LinkedIn profile links with confidence ratings.
              </p>
            </motion.div>
          </div>
        </motion.section>
